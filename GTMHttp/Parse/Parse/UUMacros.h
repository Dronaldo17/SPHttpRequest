...
#define RECT_ISNULL(rect) rect.origin.x == 0 && rect.origin.y == 0 && rect.size.width == 0 && rect.size.height == 0
...
#define BOX_SEL(x) [NSValue valueWithPointer:@selector(x)]
#define UNBOX_SEL(x) [x pointerValue]
// STRINGS
