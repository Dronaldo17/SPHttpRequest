...
- (BOOL) canUpdate {
    apiLogDebug(@"_currentVerson is %@,[self getDiskDataVersion] is %@",_currentVersion,[self getDiskDataVersion]);
    apiLogDebug(@"%d",[_currentVersion compare:[self getDiskDataVersion]] > 0);
